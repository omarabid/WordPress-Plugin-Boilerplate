...
if (!class_exists('wp_admin_table')) {
    class wp_admin_table extends WP_List_Table { 
        ...
        var $example_data = array(
            ...
            'isbn' => '978-0307454355'),
            array('ID' => 7, 'booktitle' => 'The Crown Conspiracy', 'author' => 'Michael J. Sullivan',
            'isbn' => '978-0954321130'),
            array('ID' => 8, 'booktitle'     => 'Max Quick: The Pocket and the Pendant', 'author'    => 'Mark Jeffrey',
            'isbn' => '978-0061654929'),
            array('ID' => 9, 'booktitle' => 'Jack Wakes Up: A Novel', 'author' => 'Seth Harwood',
            'isbn' => '978-4337987355'),
            array('ID' => 10,'booktitle' => 'Quarter Share', 'author' => 'Nathan Lowell',
            'isbn' => '978-1022514542'),
            array('ID' => 11, 'booktitle' => '7th Son: Descent','author' => 'J. C. Hutchins',
            'isbn' => '0312444378'),
            array('ID' => 12, 'booktitle' => 'Shadowmagic', 'author' => 'John Lenahan',
            'isbn' => '978-3005548927'),
        );
...
<?php
        ...
        public function get_views() {
            ...
            $views = array(
                'all'		=> sprintf( '<a href="%s"%s>%s</a>', remove_query_arg( array( 'filter', 'paged' ) ), $current === 'all' || $current == '' ? ' class="current"' : '', __('All', 'wp-pb') . $total_count ),
                'filter1'	=> sprintf( '<a href="%s"%s>%s</a>', add_query_arg( array( 'filter' => 'filter1', 'paged' => FALSE ) ), $current === 'filter1' ? ' class="current"' : '', __('Filter 1', 'wp-pb') . $filter1_count ),
                'filter2'	=> sprintf( '<a href="%s"%s>%s</a>', add_query_arg( array( 'filter' => 'filter2', 'paged' => FALSE ) ), $current === 'filter2' ? ' class="current"' : '', __('Filter 2', 'wp-pb') . $filter2_count ),
            );
