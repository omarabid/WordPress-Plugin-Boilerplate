...
if ( ! class_exists( 'wp_pb_admin' ) ) {
	class wp_pb_admin {
		...
		public function admin_menu() {
			...
			add_menu_page( 'WordPress Plugin BoilerPlate', 'Plugin', 'manage_options', 'page-id-1', array(
				&$this,
				'menu_hook'
			) );
		...
		public function load_scripts() {
			...
			switch ( $screen->id ) {
				case self::$pages['page-1']:
					wp_enqueue_script( 'bp-script-1', WPBP_URLPATH . 'admin/files/js/script.js' );
					break;
				case self::$pages['page-2']:
					break;
			}
		...
		public function load_styles() {
			...
			switch ( $screen->id ) {
				case self::$pages['page-1']:
					wp_enqueue_style( 'bp-script-1', WPBP_URLPATH . 'admin/files/css/style.css' );
					break;
				case self::$pages['page-2']:
					break;
			}
		...
		public function settings_form() {
			...
			add_settings_field( 'text_field', 'Text Field', 'wp_admin_forms::textbox', 'pb_general_section', 'general_section', array(
				'id'       => 'text_field',
				'text'     => '',
				'settings' => 'pb_settings'
			) );
			add_settings_field( 'checkbox_field', 'Checkbox Field', 'wp_admin_forms::checkbox', 'pb_general_section', 'general_section', array(
				'id'       => 'checkbox_field',
				'text'     => '',
				'settings' => 'pb_settings'
			) );
			add_settings_field( 'textarea_field', 'Textbox Field', 'wp_admin_forms::textarea', 'pb_general_section', 'general_section', array(
				'id'       => 'textarea_field',
				'settings' => 'pb_settings'
			) );
		}
