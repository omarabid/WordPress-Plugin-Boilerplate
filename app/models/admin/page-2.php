 ...
 * @author Abid Omar
 */
class BP_Admin_Model_Page_2 extends \omarabid\WP_MVC\Admin\Model {
	protected $data = array(
		'title' => 'Options Framework',	
	);

	public function __construct() {
		$this->data['settings'] = $this->get_options_framework_data();	
	}

	public function get_options_framework_data() {
		$options = array();
		// Test data
		$test_array = array(
